...
class ReminderScreen_ extends StatefulWidget {
  const ReminderScreen_({Key? key}) : super(key: key);

  @override
  _ReminderScreen_State createState() => _ReminderScreen_State();
}

class _ReminderScreen_State extends State<ReminderScreen_> implements TopBarClickListener{
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return _itemReminder(context, index);
                  }
                ),
              ),
  ...
  _itemReminder(BuildContext context, int index) {
    return Container(
      ...
      child: Column(
        children: [
          ListTile(
            ...
            trailing: Switch(
              value: reminderList![index].isActive!.toLowerCase() == "true",
